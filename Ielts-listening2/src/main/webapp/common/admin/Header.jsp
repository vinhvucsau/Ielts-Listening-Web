		...
		<nav class="navbar-default navbar navbar-expand-lg">
			...
			<div class="ms-auto d-flex">
				...
				<ul class="navbar-nav navbar-right-wrap ms-2 d-flex nav-top-wrap">
						...
						<div class="dropdown-menu dropdown-menu-end dropdown-menu-lg"
							...
							<div>
								<div
									...
									<span class="h4 mb-0">Notifications</span> <a href="# "> <span
										class="align-middle"> <i class="fe fe-settings me-1"></i>
									</span>
									</a>
								</div>
								<!-- List group -->
													...
													<div class="d-flex">
														...
														<div class="ms-3">
															...
															<span class="fs-6"> <span> <span
																	...
																	hours ago,
															</span> <span class="ms-1">2:19 PM</span>
															</span>
														</div>
													</div>
												</a>
													...
													<div class="d-flex">
														...
														<div class="ms-3">
															...
															<span class="fs-6"> <span> <span
																	...
																	9,
															</span> <span class="ms-1">1:20 PM</span>
															</span>
														</div>
													</div>
												</a>
													...
													<div class="d-flex">
														...
														<div class="ms-3">
															...
															<p class="mb-3">Krisitn Watsan like your comment on
																course Javascript Introduction!</p>
															<span class="fs-6"> <span> <span
																	class="fe fe-thumbs-up text-info me-1"></span> Oct 9,
															</span> <span class="ms-1">1:56 PM</span>
															</span>
														</div>
													</div>
												</a>
												...
												<a class="text-body" href="#">
													<div class="d-flex">
														...
														<div class="ms-3">
															...
															<span class="fs-6"> <span> <span
																	class="fe fe-award text-warning me-1"></span> Oct 9,
															</span> <span class="ms-1">1:56 PM</span>
															</span>
														</div>
													</div>
					...
					<!-- List -->
					<li class="dropdown ms-2"><a class="rounded-circle" href="#"
						role="button" id="dropdownUser" data-bs-toggle="dropdown"
						aria-expanded="false">
