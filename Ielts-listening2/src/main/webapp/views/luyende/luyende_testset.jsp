...
.luyende-testset-info-de-content-tile {
	display: flex;
	padding: var(--spacing-xs, 5px) 15px; justify-content : center;
	align-items : center;
...
.luyende-testset-cong-cu-loc {
	...
	<div class="luyende-testset-link-paper container-xxl">
	...
	>
			...
			<div class="luyende-testset-info-de-content col-8 ">
				<div class="row">
					<div style="padding: 0 450px;">
						<div
							class="rounded-4 bg-black luyende-testset-info-de-content-tile">
							<label class="text-center color-white">0/36 Đề</label>
						</div>
					</div>
 	...
 	<div class="container-xxl">
			<div class="luyende-testset-cong-cu  " style="padding: 50px 0;">
				<div class="row">
					<div class="col-5 "><h2>Danh sách đề</h2></div>
					<div class="col-7 luyende-testset-cong-cu-loc">
						...
						<div class="py-1 w-100 col-xl flex-grow-1 d-flex align-items-center justify-content-end position-relative border-2">
