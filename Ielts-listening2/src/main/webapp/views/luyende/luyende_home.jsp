	...
	<div class="luyende">
		...
		<div class="px-7 py-7">
			<div class="bg-white px-4 py-4 rounded-4">
				<p class="fs-5 fw-bold mb-0" style="color: rgb(0, 74, 185)">Tiếp tục làm bài</p>
			...
			<ul class="nav fs-5 fw-bold justify-content-between" style="width:500px">
			  <li class="nav-item  ">
			...
			<div class="w-100 bg-white px-4 py-4 my-5 rounded-4">
				<div class="position-relative intro d-flex flex-row">
					...
					<div class="position-absolute end-0 px-4 rounded-3 d-flex flex-column justify-content-center" style="background-color: rgb(0,177,53); color: white; height:40px;">
