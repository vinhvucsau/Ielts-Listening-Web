...
<body>
	...
	<main>
        ...
        <div class="col-lg-8 col-md-12 col-12 pt-lg-8 pb-8 pe-3">
        	<div class="border-bottom pb-3 mb-3 d-md-flex align-items-center justify-content-between">
                ...
                <div>
                	<a href="#" class="btn btn-primary" id="btn-open-popup" onclick="showModel()">Thêm bộ đề</a>
            	</div>
                                    ...
                                    <table class="table mb-0 text-nowrap table-centered table-hover table-with-checkbox">
                                        ...
                                        <tbody>
	                                        <c:forEach var="t" items="${topicList }">
	                                        	<tr class="accordion-toggle collapsed" id="accordion${t.topicId}" data-toggle="collapse" 
	                                        	data-bs-parent="#accordion" data-target="collapse${t.topicId}" value="${t.topicId}">
	                                                <td>
														<i class="topic-down-icon fe fe-chevron-down fs-4 me-2 position-absolute ms-n4 mt-1"></i>
														<h5 class="accordion-order mb-0 fit-content"></h5>
													</td>
	                                                <td>
	                                                ...
	                                                <td>
	                                                    <span class="dropdown dropstart">
	                                                        ...
	                                                        <span class="dropdown-menu" aria-labelledby="courseDropdown1">
																...
																<a href="#" class="dropdown-item btn-open-popupTest" value="${t.topicId }" >
	                                                                <i class="fe fe-plus dropdown-item-icon btn-open-popupTest"></i>
	                                                                Thêm đề thi
	                                                            </a>

	                                                            <a href="#" class="dropdown-item btn-openpopup" value="${t.topicId }" >
	                                                                <i class="fe fe-edit dropdown-item-icon"></i>
	                                                                Sửa bộ đề
	                                                            </a>
	                                                            <a class="dropdown-item" href="<c:url value='/admin/deleteTopic?id=${t.topicId}'/>">
													...
													<c:choose>
														<c:when test="${t.topicId == m.topicTests.topicId}">
															<tr class="collapse${t.topicId} mocktest-item" >
																<td> </td>
																<td>
																	<a href="<c:url value='/admin/listPart?idTest=${m.testId}'/>" class="text-inherit">
																		<span class=" text-primary-hover ms-3 fit-content">${m.testName }</span>
																	</a>
																</td>
																...
																<td>
																	<span class="dropdown dropstart">
																		...
																		<span class="dropdown-menu" aria-labelledby="courseDropdown2">
																			<a class="btn-popup-updateTest icon-link icon-update dropdown-item" href="#" value="${m.testId}">
																				<i class="fe fe-edit dropdown-item-icon"></i>
																				Sửa đề thi
																			</a>
																			<a class="dropdown-item" href="<c:url value='/admin/deleteTest?idTest=${m.testId}'/>" value="${m.testId}">
																				<i class="fe fe-trash dropdown-item-icon"></i>
																				Xóa đề thi
																			</a>
																		</span>
	...
	<div id="">
		...
		<div class="modal" id="popup-add-bo-de" tabindex="-1" role="dialog" aria-labelledby="newCatgoryLabel" aria-hidden="true">
			<div class="modal-dialog-centered modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="" method="POST" class="needs-validation form-popup" novalidate enctype="multipart/form-data">
							<div class="mb-3 mb-2 popup-title">
								<label class="form-label popup-title__text" for="title">
									Tiêu đề
									<span class="text-danger">*</span>
								</label>
								<input type="text" class="popup-title__input form-control" name="name" placeholder="Nhập tên" id="title" required>
							...
							<div class="mb-3 mb-2 popup-descript">
								...
								<input type="text" class="popup-descript__input form-control" name="description" value="" placeholder="Nhập mô tả" id="description" required>
							...
							<div class="mb-3 mb-2 popup-upload">
								...
								<div class="input-group mb-3">
									<input type="file" name="image" class="popup-upload__input form-control" accept="image/jpeg, image/png" id="img" aria-describedby="basic-addon3">
								</div>
							</div>
							...
							<div>
								...
								<button type="button" id="btn-close" class="btn btn-secondary" data-bs-dismiss="modal" onclick="hidePopup();">Thoát</button>
							</div>
						</form>
					</div>
				</div>
