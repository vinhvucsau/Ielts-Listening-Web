...
<body>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-3 lh-1">
                                        <div>
                                            <span class="fs-6 text-uppercase fw-semibold ls-md">Tổng doanh thu</span>
                                        </div>
                                        <div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12 col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-3 lh-1">
                                        <div>
                                            <span class="fs-6 text-uppercase fw-semibold ls-md">Tổng khóa học</span>
                                        </div>
                                        <div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12 col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-3 lh-1">
                                        <div>
                                            <span class="fs-6 text-uppercase fw-semibold ls-md">Tổng học viên</span>
                                        </div>
                                        <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-12 col-md-12 col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <!-- Card body -->
                                <div class="card-body">
                                    <div id="traffic1" class="apex-charts d-flex justify-content-center"></div>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	document.addEventListener("DOMContentLoaded", function() {
	  ...
	  if (orderColumn) {
	    ...
	    orderColumnChart = new ApexCharts(orderColumn, orderColumnOptions);
