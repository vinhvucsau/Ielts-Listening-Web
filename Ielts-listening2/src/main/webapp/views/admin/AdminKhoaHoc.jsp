						...
						<div style="max-height: 450px" class=" overflow-auto">
							<div class="card-body">
								<div class="mb-3">
									...
									<input id="" name="courseName" class="form-control" type="text"
										placeholder="Tên khóa học" required> <small>Write
								...
								<div class="d-flex align-items-center justify-content-between">
									<div style="min-width: 350px" class="mb-3">
										<label for="fee" class="form-label">Học phí</label> <input
											id="" name="cost" class="form-control" type="text"
								...
								<div class="mb-3">
									<label class="form-label">Thêm ảnh bìa</label> <input
										type="file" class="form-control" name="image" id=""
								...
								<div>
									...
									<div class="mb-3">
										<label class="form-label">Thêm video xem trước</label> <input
											type="file" class="form-control" name="trailer" id=""
										...
										<div class="me-2">
											...
											<div class="nav btn-group flex-nowrap" role="tablist">
												...
												<button class="btn btn-outline-secondary"
													...
													role="tab" aria-controls="tabPaneList"
													aria-selected="false">
 ...
 -->
							...
							<div class="col-xl-12 col-lg-9 col-md-8 col-12">
								<div class="tab-content">
									...
									<!-- Tab pane -->
									<div class="tab-pane fade pb-4" id="tabPaneList"
										role="tabpanel" aria-labelledby="tabPaneList">
										<!-- Card -->
										<c:forEach var="i" items="${course}">
											<div class="card mb-4 card-hover">
												<div class="row g-0">
													...
													<div class="col-lg-9 col-md-12 col-12">
                                                        ...
                                                        <path
																...
																<li class="list-inline-item"><svg
																		class="me-1 mt-n1" width="16" height="16"
																		viewBox="0 0 16 16" fill="none"
																		xmlns="http://www.w3.org/2000/svg">
                                                                <rect
																			x="3" y="8" width="2" height="6" rx="1"
																			fill="#754FFE"></rect>
                                                                <rect
																			x="7" y="5" width="2" height="9" rx="1"
																			fill="#DBD8E9"></rect>
                                                                <rect
