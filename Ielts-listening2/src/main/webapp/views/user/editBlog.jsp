			...
			<div id="test-l-1" class="bs-stepper-pane"
				...
				<div class="card mb-3">
					<div class="card-header border-bottom px-4 py-3">
						<h4 class="mb-0">Chỉnh sửa blog</h4>
					</div>
					<!-- Card body -->
						...
						<div class="card-body">
							<div class="mb-3">
								<label for="courseTitle" class="form-label">Title</label><input
									...
									placeholder="Title" required value="${blog.title}"> <small>Write
									a 60 character blog title.</small>
							</div>

							<div class="mb-3 d-flex flex-column gap-3">
								<label class="form-label">Thumbnail</label> <img alt=""
									style="max-width: 400px"
									src="<c:url value='/image?fname=blogIMG/${blog.image }'/>">
