			...
			<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-xl-8 col-lg-8 col-md-12 col-12 mb-2">
						...
						<div>
							<div class="mb-4">
								<h3 class="lead text-dark">${blog.content}</h3>
								<p>
						...
						<div class="py-lg-8 py-6">
							<div class="text-center mb-6">
								...
								<p class="mb-0 lead">Join our newsletter and get resources,
									curated content, and design inspiration delivered straight to
									your inbox.</p>
							</div>
							<!-- Form -->
							<form class="row px-md-8 mx-md-8 gx-2 needs-validation"
								novalidate>
								<div class="col">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-12"> 
							...
							<div class="card mb-4 shadow-lg card-lift">
								<a href="blog-single.html"><img
									src="<c:url value='/image?fname=${folder}/${list.image }'/>" class="card-img-top"
									alt="blogpost "></a>
								<!-- Card body -->
								<div class="card-body">
