	...
	<section class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-12">
				<div
					class="border-bottom pb-3 mb-3 d-flex align-items-center justify-content-between">
					<div>
					...
					<div class="card-header p-0">
						<ul class="nav nav-lb-tab border-bottom-0" id="tab" role="tablist">
							...
							<li class="nav-item"><a class="nav-link" id="published-tab"
								data-bs-toggle="pill" href="#all-post" role="tab"
							...
							$('.dropdown-item')
									.hover(
											function(e) {
												...
												var urlAction;
												if ($(this).hasClass(
														'blog-edit-btn')) { //edit btn 
													urlAction = "<c:url value='/user/edit-blog?id="
															+ String(id)
															+ "'/>";
													...
													return;
														...
														'blog-publish-btn')) { //publish btn 
													urlAction = "<c:url value='/admin/update-blog-status?id="
															+ String(id)
															+ "&status="
															+ String(1) + "'/>";
													e.target.setAttribute(
