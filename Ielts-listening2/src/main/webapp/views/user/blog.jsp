                ...
                <div class="card rounded-3">
                    ...
                    <div class="card-header p-0">
                        <ul class="nav nav-lb-tab border-bottom-0" id="tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="published-tab" data-bs-toggle="pill" href="#all-post" role="tab" aria-controls="published" aria-selected="false">Đã duyệt</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="scheduled-tab" data-bs-toggle="pill" href="#all-post" role="tab" aria-controls="scheduled" aria-selected="false">Chờ duyệt</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="draft-tab" data-bs-toggle="pill" href="#all-post" role="tab" aria-controls="draft" aria-selected="false">Bản nháp</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="deleted-tab" data-bs-toggle="pill" href="#all-post" role="tab" aria-controls="deleted" aria-selected="false">Thùng rác</a>
                            </li>
                        </ul>
                    </div>
                    <div class="p-4 row">
                        ...
                        <div class="tab-content" id="tabContent">
                            ...
                            <div class="tab-pane fade show active" id="all-post" role="tabpanel" aria-labelledby="all-post-tab">
                                <div class="container table-responsive">
                                    <!-- Table -->
                                    <table id="" class="table-pag table mb-0 text-nowrap table-centered table-hover table-with-checkbox table-centered table-hover">
                                        <!-- Table Head -->
                                        ...
                                        <!-- Table body -->
                                        <tbody>
                                            <c:forEach var="blog" items="${listBlog}" varStatus="thisblog">
                                                ...
                                                <c:choose>
                                                    <c:when test="${blog.users.userId == user.userId}">
                                                        <tr class="blog-item" data-value="${blog.status}">
                                                            ...
                                                            <td>
                                                                <div class="blog-user d-flex align-items-center" value="${user.account.role}">
                                                                    <img src="<c:url value='/image?fname=${folder}/${user.image}'/>" alt="" class="blog-user__img rounded-circle avatar-xs me-2" >
