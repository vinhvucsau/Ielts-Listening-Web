...
public class EnrollTestDaoImpl extends AbstractDao<EnrrolTest> implements IEnrollTestDAO{
	...
	public List<EnrrolTest> getEnrollTestByUserId(String userId, String topicId) {
	    ...
	    String jpql = "SELECT   e " +
	            ...
	            "AND e.mockTests.topicTests.topicId = :topicId " +
	            "AND e.score = (" +
	            "   SELECT MAX(et.score) " +
	            "   FROM EnrrolTest et " +
	            "   WHERE et.mockTests.testId = e.mockTests.testId " +
	            "   AND et.users.userId = :userId " +
	            "   AND et.mockTests.topicTests.topicId = :topicId" +
	            ")";
